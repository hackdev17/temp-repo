...
\urlstyle{same}
\fancyhf{}
\fancyhead[L]{\hrule \vspace{-1.25em} Social Connect and Responsibility (BSCK307) \vspace{.25em}}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{Department of Artificial Intelligence \& Machine Learning \vspace{-1.25em} \hrule}
...
\newcommand{\nborder}{
	\tikz[overlay, remember picture]{
		...
		rectangle ++ (\paperwidth-1in,-\paperheight+1in)
		node[below]{
			\thepage \hspace{1.222225\columnwidth}
		};
	}
}
...
\begin{document}
	...
	\thispagestyle{empty} \vspace{-5em} \tableofcontents \thispagestyle{empty}

	\section*{References} \nborder
	Mangifera indica \dotfill ~~ 1 \\
	\indent Wikipedia : Mango\\
	\indent\indent \url{https://simple.wikipedia.org/wiki/Mango} \\
	Organic Farming \dotfill ~~ 6 \\
	\indent Wikipedia : Organic farming\\
	\indent\indent \url{https://en.wikipedia.org/wiki/Organic_farming}

	\section*{List of Tables}
	\noindent Biomass production \& Nutrient content of green manure crops \dotfill ~~ 9 \\
	Nutrient content of green manure crops \dotfill ~~ 9 \\ ~
	\thispagestyle{empty} \newpage
	\pagenumbering{arabic}
	\setcounter{page}{1}
	\chapter{1}{PLANTATION AND ADOPTATION OF TREE}
	...
	\begin{center}
		\img{.7}{Plant/me_with_plant.jpg} \\ Mango grown for 2 months
	\end{center} \newpage
	...
	\begin{center}
		\section*{CONCLUSION}
	\end{center} \addcontentsline{toc}{section}{CONCLUSION}
